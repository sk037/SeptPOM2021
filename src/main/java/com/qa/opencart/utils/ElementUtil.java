...
//		}
	...
	public void postalCode(By locator, String value) {
		doClear(locator);
...
//	}
	...
	public WebElement waitForElementToBeVisible1(WebElement a, int timeOut, int intervalTime) {
		// TODO Auto-generated method stub
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(timeOut), Duration.ofMillis(intervalTime));
		return wait.until(ExpectedConditions.visibilityOf(getElement(a)));
